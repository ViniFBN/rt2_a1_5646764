...
# service callbacks
'''
For the SetBool service definition:
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('/reaching_goal_point', assignment_2_2022.msg.PlanningAction, desired_pos, auto_start=False)
    act_s.start()
